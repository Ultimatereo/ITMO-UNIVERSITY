...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(curHead, curHeadNext)) {
                // It's very important to set prev exactly here and not in if-clause
                // Otherwise we risk that somewhere we can get to curHead through curHeadNext!
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            // TODO: the algorithm.
            val removing = markExtractedOrRemoved()
            if (prev.get() != null && next.get() != null) {
                removePhysically()
            }
            return removing
        }
