...
public class zad4 {
	...
	public static void main (String[] args) throws IOException{
		...
		// 	new FileInputStream("testin.txt"), "UTF-8")), reverseChecker);
		// PrintWriter output = new PrintWriter("testout.txt");
		Scanner input = new Scanner(new BufferedReader(new InputStreamReader(
				new FileInputStream("chaincode.in"), "UTF-8")), reverseChecker);
		PrintWriter output = new PrintWriter("chaincode.out");
		int n = input.nextInt();
		input.close();
