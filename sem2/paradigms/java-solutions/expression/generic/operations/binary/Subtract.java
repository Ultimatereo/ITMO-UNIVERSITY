...
public class Subtract<T> extends AbstractBinaryOperation<T> {
    ...
    public Subtract(UltimateExpression<T> expression1, UltimateExpression<T> expression2, Operations<T> operationMode) {
    ...
    public T evaluate(T x, T y, T z) {
        return operationMode.subtract(expression1.evaluate(x, y, z), expression2.evaluate(x, y, z));
    }
}
